...
const AdminDashboard = () => {
    ...
    const cards = [
        ...
        {
            title: t('admin.stats.availableVolunteers') || 'Available Volunteers',
            value: stats.available_volunteers || 0,
            icon: 'M5 13l4 4L19 7',
            color: 'bg-green-500'
        },
        {
            title: t('admin.stats.shelters'),
            value: stats.total_shelters || 0,
            icon: 'M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4',
            color: 'bg-sky-500'
        },
        {
            title: t('admin.stats.openShelters') || 'Open Shelters',
            value: stats.open_shelters || 0,
            icon: 'M5 13l4 4L19 7',
            color: 'bg-emerald-500'
        },
        {
            title: t('admin.stats.reliefPending'),
            value: stats.relief_pending || 0,
